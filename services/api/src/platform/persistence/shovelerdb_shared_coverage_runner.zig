...
extern fn invoice_manager_shared_coverage_reset() void;
extern fn invoice_manager_shared_coverage_hit_bits() u64;
extern fn invoice_manager_shared_coverage_required_bits() u64;
...
const Config = struct {
    ...
    pub fn hitBits() u64 {
        return invoice_manager_shared_coverage_hit_bits();
    }
...
export fn runner_test_name(_: u32) fuzz.Slice {
    return .fromSlice("shared-coverage");
}
