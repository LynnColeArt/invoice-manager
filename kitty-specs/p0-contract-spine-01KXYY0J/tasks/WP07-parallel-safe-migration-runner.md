...
20. Import WP04's build-wired probe in production with exact `const migration_coverage = @import("migration_coverage_probe");`. Coverage tests may import only the public migration module and must never import or mutate the probe directly.
